...
Cargo تمام APIهای غیر خصوصی سازگار با ورژن 0..0.8 ا در نظر میگیرد 
...
در مثال‌های ذیل ورژن‌های`0.9.0`و یا بالاتر از ممکن است از API های عمومی دیگری بهره گیرند.
